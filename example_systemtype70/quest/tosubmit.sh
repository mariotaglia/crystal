#!/bin/bash
#SBATCH --account=p31819  ## Required: your allocation/account name, i.e. eXXXX, pXXXX or bXXXX
...
#SBATCH --mem=16G ## how much RAM do you need per computer/node (this affects your FairShare score so be careful to not ask for more than you need))
#SBATCH --job-name=prueba ## When you run squeue -u  this is how you can identify the job
...
mpirun -np 8 /projects/p31819/bin/crystal
